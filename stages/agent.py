...
2. **Планирование**: Уточни аудиторию, тон, количество слайдов (по одному вопросу). Предлагай дефолт: {defaults.count} слайдов. Когда готово — вызови propose_slide_plan. Жди подтверждения.
